...
class InsorgInfoList:
    def __init__(self):
        ...
        m.append( [1, u'АЛТАЙСКИЙ ФИЛИАЛ ООО "СТРАХОВАЯ МЕДИЦИНСКАЯ КОМПАНИЯ РЕСО-МЕД"', 5035000265, None, None] )
        m.append( [2, u'ФИЛИАЛ ЗАО "КАПИТАЛЪ МЕДИЦИНСКОЕ СТРАХОВАНИЕ" В Г.БАРНАУЛЕ"', 0, None, None] )
        m.append( [3, u'ФИЛИАЛ "АЛТАЙСКИЙ" ЗАО "СТРАХОВАЯ ГРУППА СПАССКИЕ ВОРОТА-М"', 7717044533,  None, None] )
        m.append( [4, u'БАРНАУЛЬСКИЙ ФИЛИАЛ ОАО СМО "СИБИРЬ"', 4205080364,  None, None] )
        m.append( [5, u'ФИЛИАЛ ЗАО МЕДИЦИНСКАЯ СТРАХОВАЯ КОМПАНИЯ "СОЛИДАРНОСТЬ ДЛЯ ЖИЗНИ" В А', 7704103750,  None, None] )
        m.append( [6, u'ФИЛИАЛ ООО "РГС-МЕДИЦИНА" - "РОСГОССТРАХ-АЛТАЙ-МЕДИЦИНА"', 7813171100,  None, None] )
        m.append( [7, u'ООО СТРАХОВАЯ МЕДИЦИНСКАЯ КОМПАНИЯ "СЕДАР-М"', 2221065779,  None, None] )
        m.append( [8, u'ООО СТРАХОВАЯ КОМПАНИЯ "ИНТЕРМЕДСЕРВИС-СИБИРЬ"', 2224052640,  None, None] )
        # -- DB END --
