#!/usr/bin/python
# -*- coding: utf-8 -*-
# insb-cad-5.py - импорт файлов MO в DBMY (mis.mo_cad)
#
...
if __name__ == "__main__":
    ...
    log.info('Registering of MO_CAD Files. Start {0}'.format(localtime))
    ...
    localtime = time.asctime( time.localtime(time.time()) )
    log.info('Registering of MO_CAD Files. Finish  '+localtime)
