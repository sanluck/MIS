...
FNAME = "IM22M220000_{0}{1}.csv"
#FNAME = Config2['fname']
STEP = int(Config2['step'])
...
if USE_DATERANGE == "1":
    ...
    SQLT_APLIST = """SELECT ap.area_people_id, ap.people_id_fk, ca.clinic_id_fk
...
AND ap.date_beg BETWEEN '{0}' AND '{1}'
AND ap.date_end is Null
ORDER BY area_people_id;""".format(D_START,D_FINISH)
